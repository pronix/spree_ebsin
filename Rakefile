...
desc 'Generate documentation for the ebsin_gateway extension.'
Rake::RDocTask.new(:rdoc) do |rdoc|
  rdoc.rdoc_dir = 'rdoc'
  rdoc.title    = 'EbsinGatewayExtension'
...
desc 'Test the ebsin_gateway extension.'
...
namespace :test do
  desc 'Functional test the ebsin_gateway extension.'
  ...
  desc 'Unit test the ebsin_gateway extension.'
